    ...
    <div>
      <div className="relative min-h-screen">
        <div
          ...
          style={{
            backgroundImage: 'url("https://i.ibb.co/Dg6W4BmH/image.png")',
          }}
        ></div>
        <div className="absolute  bg-black opacity-40 z-10"></div>
        <div className="relative z-20 flex flex-col justify-center items-center min-h-screen md:pt-72 pt-56">
